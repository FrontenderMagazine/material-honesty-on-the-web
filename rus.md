Использование честных материалов в вебе
...
И художественный критик Джон Рёскин, и дизайнеры Чарльз и Рей Имз (Charles and 
...
производят вот уже восемдесят лет без перерывов. 
...
В наше время ведутся прения по поводу [плоского][1] и [скевоморфического][2] 
дизайна. Хотя споры о трендах в дизайне - это нормальное явление, 
продолжительное взаимное высмеивание затягивает проблему: ребята по обе стороны 
баррикад пока не могут окончательно обозначить свои позиции и терминологию. 
...
В статье «Веб-эстетика» Пол Роберт Ллойд (Paul Robert Lloyd) определяет понятие 
основы.  

> Веб фактически можно рассматривать как комплекс, состоящий из протокола HTTP 
(«как?»), локаторов URL («где?») и разметки HTML («что?»). Отбросьте один из 
этих компонентов и это будет уже не веб.

По степени важности можете рассположить их как вам угодно, но если эти протоколы 
отсутствуют, это не веб. Он не честен.

Например, флеш-сайт, не содержащий материалов основы, не будет загружаться на 
многих популярных устройствах. Поскольку **страницы** флеш-сайта не имеют 
настоящих адресов URL, они не являются **честными страницами**, для них сложно 
создать постоянные ссылки, ими нельзя поделиться обычными способами, по ним 
сложно осуществлять навигацию (так как кнопка браузера «назад» выдает 
...
не обязателен). Эти веб-материал, лежащие на самой поверхности, делятся на две 
...
нарушать правила, играть с ними и все же производить отличные и долгосрочные 
работы. 
...
Вместо того, чтобы выбирать наиболее честного инструмента из [списка современных 
...
континууме, и тех кто не желает прилагать к этому усилий. Пора прекратить 
